...
shoulder_floor_pos_auto = 1.48 # changed from 1.44 to 1.46, might change again later (coach lisa told me to change pls dont get mad)
...
auton_middle_note_shoulder = 0.9 # Change this to affect the auto shots for ONLY middle autons (where we start in the middle position)
