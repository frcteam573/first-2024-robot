...
from autonomous.paths.TRAP_1.coords.blue import (
    blue_team,
    go_to_trap_1,
    initial,
)
...
path_1 = FollowPathCustom(
    ...
    trajectory=CustomTrajectory(
        start_pose=Pose2d(*go_to_trap_1[0]),
        waypoints=[Translation2d(*x) for x in go_to_trap_1[1]],
        end_pose=Pose2d(*go_to_trap_1[2]),
