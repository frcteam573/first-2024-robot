...
from autonomous.paths.HUMAN_2.coords.blue import (
    blue_team,
    go_to_human_2,
    initial,
)
...
path_1 = FollowPathCustom(
    ...
    trajectory=CustomTrajectory(
        start_pose=Pose2d(*go_to_human_2[0]),
        waypoints=[Translation2d(*x) for x in go_to_human_2[1]],
        end_pose=Pose2d(*go_to_human_2[2]),
