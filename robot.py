...
class MyRobot(commands2.TimedCommandRobot):
    ...
    def robotInit(self) -> None:
        ...
        self.shoulder1_power = self.power.add("Shoulder 1", self.PDP.getCurrent(47)).withWidget(BuiltInWidgets.kGraph).getEntry()
        self.shoulder2_power = self.power.add("Shoulder 2", self.PDP.getCurrent(48)).withWidget(BuiltInWidgets.kGraph).getEntry()
    ...
    def robotPeriodic(self) -> None:
        ...
        self.shoulder1_power.setDouble(self.PDP.getCurrent(47))
        self.shoulder2_power.setDouble(self.PDP.getCurrent(48))
